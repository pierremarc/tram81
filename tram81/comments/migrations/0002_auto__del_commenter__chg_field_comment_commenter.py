...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.commenter'
        db.alter_column(u'comments_comment', 'commenter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Comment.commenter'
        db.alter_column(u'comments_comment', 'commenter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Commenter']))
